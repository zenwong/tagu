...
QT_MOC_LITERAL(6, 51, 8)
    ...
    "Worker\0valueChanged\0\0value\0finished\0"
    "importFinished\0mainLoop\0"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->importFinished(); break;
        ...
        {
            typedef void (Worker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Worker::importFinished)) {
                *result = 2;
            }
        }
    }
