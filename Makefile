#############################################################################
# Makefile for building: Tagu
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Tagu.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Tagu.pro
#############################################################################
...
Makefile: Tagu.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/lib/libQt5Gui.prl \
		/lib/libQt5Core.prl
	$(QMAKE) -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Tagu.pro
...
dist: 
	@test -d .tmp/Tagu1.0.0 || mkdir -p .tmp/Tagu1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Tagu1.0.0/ && $(COPY_FILE) --parents MainWindow.hpp ImageDelegate.hpp delegates/ThumbnailDelegate.hpp Worker.hpp SettingsDialog.hpp .tmp/Tagu1.0.0/ && $(COPY_FILE) --parents main.cpp MainWindow.cpp delegates/ThumbnailDelegate.cpp Worker.cpp SettingsDialog.cpp .tmp/Tagu1.0.0/ && $(COPY_FILE) --parents MainWindow.ui SettingsDialog.ui .tmp/Tagu1.0.0/ && (cd `dirname .tmp/Tagu1.0.0` && $(TAR) Tagu1.0.0.tar Tagu1.0.0 && $(COMPRESS) Tagu1.0.0.tar) && $(MOVE) `dirname .tmp/Tagu1.0.0`/Tagu1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Tagu1.0.0
